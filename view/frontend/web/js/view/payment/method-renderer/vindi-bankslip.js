define(
    ...
    function (_, Component, $t, $, utils, taxvat, documentValidate) {
        ...
        return Component.extend({
            defaults: {
                template: 'Vindi_Payment/payment/vindi-bankslip',
                taxvat: taxvat
            },

            initialize: function () {
                this._super();
                this.taxvat.value(window?.checkoutConfig?.payment?.vindi_bankslip?.customer_taxvat);
            },

            isActiveDocument: function () {
                return window?.checkoutConfig?.payment?.vindi_bankslip?.enabledDocument;
            },
